...
//! and the direct namespace/Landlock backend that creates isolated execution
//! environments for Claude Code sessions.
//!
//! # Platform support
//!
//! The sandbox backend (namespace isolation, Landlock, nftables, cgroups) is
...
#[cfg(target_os = "linux")]
pub use sandbox::DirectSandbox;
#[cfg(target_os = "linux")]
pub use session::{PreparedSandbox, SandboxSessionConfig, prepare_sandbox};
